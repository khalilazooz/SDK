...
void lcd_send_command (uint_8 command)
{
...
void lcd_write_word(uint_8 word[20])
{
	int i=0;
	while(word[i]!='\0')
	{
...
void lcd_write_character(uint_8 character)
{
...
void lcd_goto_xy (uint_8 line,uint_8 pos)				//line = 0 or 1
{
